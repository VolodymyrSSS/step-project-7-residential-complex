// ! Селектор для посилань - на яких потрібно викликати youtubeLightbox
const linksBtnsSelector = 'a[data-youtubeLightbox]'; // буде працювати тільки для посилань (не для кнопок)
